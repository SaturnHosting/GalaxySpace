...
import galaxyspace.systems.SolarSystem.moons.deimos.dimension.sky.SkyProviderDeimos;
import galaxyspace.systems.SolarSystem.moons.deimos.world.gen.BiomeProviderDeimos;
...
public class WorldProviderDeimos extends WorldProviderAdvancedSpace implements IProviderFreeze{
	...
	public CelestialBody getCelestialBody() {
		return SolarSystemBodies.deimosMars;
	}
    ...
    public IRenderHandler getSkyRenderer()
    {
		...
		{
			this.setSkyRenderer(new SkyProviderDeimos());
		}
