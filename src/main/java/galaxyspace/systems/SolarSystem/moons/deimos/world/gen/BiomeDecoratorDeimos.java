...
public class BiomeDecoratorDeimos extends BiomeDecoratorSpace
{
    ...
    {
    	OreGenIron = new WorldGenMinableMeta(GSBlocks.DEIMOS_BLOCKS, 6, 2, true, GSBlocks.DEIMOS_BLOCKS, 1); 
    	OreGenNickel = new WorldGenMinableMeta(GSBlocks.DEIMOS_BLOCKS, 6, 4, true, GSBlocks.DEIMOS_BLOCKS, 1); 
    	OreGenDesh = new WorldGenMinableMeta(GSBlocks.DEIMOS_BLOCKS, 4, 5, true, GSBlocks.DEIMOS_BLOCKS, 1); 
    	OreGenMeteoricIron = new WorldGenMinableMeta(GSBlocks.DEIMOS_BLOCKS, 3, 3, true, GSBlocks.DEIMOS_BLOCKS, 1); 
    	OreGenRegolite = new WorldGenMinableMeta(GSBlocks.DEIMOS_BLOCKS, 20, 0, true, GSBlocks.DEIMOS_BLOCKS, 1); 
    }
