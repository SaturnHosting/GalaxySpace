package galaxyspace.systems.SolarSystem.moons.deimos.dimension.sky;
...
public class SkyProviderDeimos extends SkyProviderBase
{
	...
	protected void rendererSky(Tessellator tessellator, BufferBuilder worldRenderer, float f10, float ticks) {
		...
		this.renderImage(phobosTexture, (this.mc.world.getCelestialAngle(ticks) * 360F) / 4, 95F, 10F, 4.0F);
		
		this.renderImage(marsTexture, 90F, 90F, 0F, 45F, 1.0F, .4F);
